...
DEBUG = False
ALLOWED_HOSTS = ["127.0.0.1",'localhost', 'lkleemiss.pythonanywhere.com']

#Redirect when doent have access to page
LOGIN_URL = 'login'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.task.context_processors.user_tasks',
                'apps.time_entry.context_processors.user_time_entries',
            ],
        },
    },
]
